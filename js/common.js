let menuItems = [{"item":"Home","link":"home.html"},{"item":"Impact","link":"impact.html"},{"item":"Benefits","link":"benefits.html"},{"item":"Research","link":"research.html"},{"item":"Researchers","link":"researchers.html"},{"item":"Photo Gallery","link":"photogallery.html"}]
//Menu Start
    ...
    for (let i = 0; i < webelements.length; i++) {
        ...
        if (type == 'ph') {
            ...
            content += '<div class = "col-xl-4 col-lg-4 col-md-4" style="text-align: center;padding-bottom: 10px;">' +
                ...
                '<img class = "home-logo" style = "width: 200px;height: 200px;border: 5px solid #f2b368;" src = "https://sdat-dev.github.io/resources/wiser/assets/images/' + filename + '/' + element.logo + '">' +
                '<p>' + element.content + '</p>' +
                '</div>' +
                '</a>' +
                '</div>';
...
let addheader = function (headers) {
    ...
    if ((window.location.href).includes('home.html')) {
        ...
        for (var i = 0; i < headers.length; i++) {
            ...
            let source = 'https://sdat-dev.github.io/resources/wiser/assets/images/' + filename + '/' + (typeof headers[i].source != 'undefined' && headers[i].source != '' ? headers[i].source + ' / ' : '');
            if (i == 0) {
        ...
        for (var i = 0; i < headers.length; i++) {
            ...
            if (filename.includes("project")) {
                source = 'https://sdat-dev.github.io/resources/wiser/assets/images/researchareas/' + (typeof headers[i].source != 'undefined' && headers[i].source != '' ? headers[i].source + '/' : '');
            }
            else {
                source = 'https://sdat-dev.github.io/resources/wiser/assets/images/' + filename + '/' + (typeof headers[i].source != 'undefined' && headers[i].source != '' ? headers[i].source + '/' : '');
            }
...
addfooter = function (relativepath = ".") {
    ...
    content +=
        ...
        '<img alt="NSF Logo" class="nsf-logo" src="https://sdat-dev.github.io/resources/wiser/assets/images/' + 'footer/nsf-footer.png"  />' +
        ...
        '<img alt="University at Albany Logo" class=" img-responsive footer-logo" height="39" src="https://sdat-dev.github.io/resources/wiser/assets/images/' + 'footer/ualbany-footer-logo.png" typeof="Image" />' +
        '</a>' +
        '<p>' +
        ...
        'width: 2000px;" class=" img-responsive footer-logo" height="39" src="https://sdat-dev.github.io/resources/wiser/assets/images/' + 'footer/uconn-footer-logo.png" typeof="Image" />' +
        '</a>' +
        '<p>' +
