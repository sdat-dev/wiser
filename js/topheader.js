        ...
        '<div class="region region-navigation"><a href="#" class="menu-burger" title="Toggle Mobile Menu Navigation"><span class="fa fa-bars" role="img" aria-label="mobile menu icon" aria-hidden="true"></span><span class="sr-only">Toggle Mobile Menu Navigation</span></a>'+
            '<section>'+
                '<div class="field field--name-body field--type-text-with-summary field--label-hidden field--item">'+
                    ...
                    //     '<ul>'+
                    //         '<li><img id="albany-logo-minerva" alt="Uconn-Minerva" src="../resources/wiser/assets/images/top-menu/albany-logo-text.png"></li>'+
                    //         '<li><img id="albany-logo-minerva" alt="Uconn-Minerva" src="../resources/wiser/assets/images/top-menu/uconn-logo-text-1.png"></li>'+
                    //     '</ul>'+
                    // '</nav>'+
